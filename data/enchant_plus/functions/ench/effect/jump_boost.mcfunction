#> enchant_plus:ench/effect/jump_boost
# @within function enchant_plus:ench/effect/

execute store result score $lvl CE.Temporary run data get storage _index.d:enchant_plus Data.Player.Inventory[{Slot:101b}].tag.CustomEnchantments[{id:"enchant_plus:jump_boost"}].lvl 2
