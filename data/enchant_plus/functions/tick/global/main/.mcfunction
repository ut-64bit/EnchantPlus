...
execute as @e[type=armor_stand,tag=Arrow.LightningStrike] unless data entity @s {FallDistance:0.0f} at @s run function enchant_plus:ench/lightning_strike/hit
