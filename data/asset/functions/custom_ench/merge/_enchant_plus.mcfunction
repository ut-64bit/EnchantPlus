...
scoreboard players set $Ench CE.Temporary 0
    ...
    execute if data storage _index.d:custom_ench Data.Add.Enchantments[{id:"enchant_plus:fire_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:blast"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:spark_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:charge_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:lightning_strike"}] run function asset:custom_ench/merge/fire_shot
    ...
    execute if data storage _index.d:custom_ench Data.Add.Enchantments[{id:"enchant_plus:blast"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:power_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:spark_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:fire_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:charge_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:lightning_strike"}] run function asset:custom_ench/merge/blast
    ...
    execute if data storage _index.d:custom_ench Data.Add.Enchantments[{id:"enchant_plus:charge_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:blast"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:spark_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:lightning_strike"}] run function asset:custom_ench/merge/charge_shot
    execute if data storage _index.d:custom_ench Data.Add.Enchantments[{id:"enchant_plus:spark_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:power_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:fire_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:blast"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:charge_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:lightning_strike"}] run function asset:custom_ench/merge/spark_shot
    execute if data storage _index.d:custom_ench Data.Add.Enchantments[{id:"enchant_plus:lightning_strike"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:power_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:fire_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:blast"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:charge_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:spark_shot"}] run function asset:custom_ench/merge/lightning_strike
