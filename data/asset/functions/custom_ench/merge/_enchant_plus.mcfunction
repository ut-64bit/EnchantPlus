...
scoreboard players set $Ench CE.Temporary 0
    ...
    execute if data storage _index.d:custom_ench Data.Add.Enchantments[{id:"enchant_plus:fire_shot"}] unless data storage _index.d:custom_ench Data.Base.Enchantments[{id:"enchant_plus:blast"}] run function asset:custom_ench/merge/fire_shot
