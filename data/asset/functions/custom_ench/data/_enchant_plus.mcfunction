...
# ChargeShot
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low[{id:"enchant_plus:charge_shot"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:charge_shot",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:charge_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:charge_shot",Level:1}

# SparkShot
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low[{id:"enchant_plus:spark_shot"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:spark_shot",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:spark_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:spark_shot",Level:1}
