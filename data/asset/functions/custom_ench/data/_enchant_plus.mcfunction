...
# Satiety
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:satiety"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:satiety",Level:3}
...
# JumpBoost
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:jump_boost"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:jump_boost",Level:3}
...
# Health+
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:health_plus"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:health_plus",Level:5}
...
# Haste
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:haste"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:haste",Level:3}
...
# XPBoost
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:xp_boost"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:xp_boost",Level:1}
...
# AutoRepair
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:auto_repair"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:auto_repair",Level:1}
...
# MultiShot
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:multi_shot"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:multi_shot",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:multi_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:multi_shot",Level:1,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:multi_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:multi_shot",Level:1,Enable:false}

# PowerShot
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:power_shot"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:power_shot",Level:1}
...
# Healthy
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:healthy"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:healthy",Level:3}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low[{id:"enchant_plus:healthy"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low append value {id:"enchant_plus:healthy",Level:1,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:healthy"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:healthy",Level:2,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:healthy"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:healthy",Level:3,Enable:false}

# Critical
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:critical"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:critical",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:critical"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:critical",Level:1,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:critical"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:critical",Level:1,Enable:false}

# ShieldBash
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:shield_bash"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:shield_bash",Level:1}
...
# JustGuard
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:just_guard"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:just_guard",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:just_guard"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:just_guard",Level:1,Enable:false}

# NightVision
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:night_vision"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:night_vision",Level:1}
...
# Magnet
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:magnet"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:magnet",Level:1}
...
# PoisonBlade
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:poison_blade"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:poison_blade",Level:1,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:poison_blade"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:poison_blade",Level:1,Enable:false}

# MultiJump
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:multi_jump"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:multi_jump",Level:3}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:multi_jump"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:multi_jump",Level:2,Enable:false}

# Cutter
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:cutter"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:cutter",Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low[{id:"enchant_plus:cutter"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low append value {id:"enchant_plus:cutter",Level:1,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:cutter"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:cutter",Level:1,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:cutter"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:cutter",Level:1,Enable:false}

# Mine+
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:mine_plus"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:mine_plus",Level:1}
...
# Homing
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:homing"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:homing",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:homing"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:homing",Level:1,Enable:false}

# AutoSmelt
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:auto_smelt"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:auto_smelt",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:auto_smelt"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:auto_smelt",Level:1,Enable:false}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:auto_smelt"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:auto_smelt",Level:1,Enable:false}

# FireShot
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:fire_shot"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:fire_shot",Level:1}
...
# SoulBind
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:soul_bind"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:soul_bind",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:soul_bind"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:soul_bind",Level:1,Enable:false}

# Harvest
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:harvest"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:harvest",Level:1}
...
# IceSpeed
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:ice_speed"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:ice_speed",Level:1}
...
# Replant
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:replant"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:replant",Level:1}
...
# AntiVenom
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:anti_venom"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:anti_venom",Level:3}
...
# Explosion
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:explosion"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:explosion",Level:3}
...
# Rader
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:rader"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:rader",Level:1}
...
# AttackSpeed
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:attack_speed"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:attack_speed",Level:3}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:attack_speed"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:attack_speed",Enable:true,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:attack_speed"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:attack_speed",Enable:true,Level:2}

# Feather
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:feather"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:feather",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:feather"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:feather",Enable:true,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:feather"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:feather",Enable:true,Level:1}

# Agility
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:agility"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:agility",Level:3}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:agility"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:agility",Enable:true,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:agility"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:agility",Enable:true,Level:2}

# Blast
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:blast"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:blast",Level:1}
    ...
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:blast"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:blast",Enable:true,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:blast"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:blast",Enable:true,Level:1}

# ChargeShot
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:charge_shot"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:charge_shot",Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low[{id:"enchant_plus:charge_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low append value {id:"enchant_plus:charge_shot",Enable:false,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:charge_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:charge_shot",Enable:false,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:charge_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:charge_shot",Enable:true,Level:1}

# SparkShot
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:spark_shot"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:spark_shot",Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low[{id:"enchant_plus:spark_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low append value {id:"enchant_plus:spark_shot",Enable:false,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:spark_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:spark_shot",Enable:false,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:spark_shot"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:spark_shot",Enable:true,Level:1}

# LightningStrike
    execute unless data storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant[{id:"enchant_plus:lightning_strike"}] run data modify storage asset:custom_ench Data.Asset.Custom[{Namespace:"enchant_plus"}].Enchant append value {id:"enchant_plus:lightning_strike",Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low[{id:"enchant_plus:lightning_strike"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Low append value {id:"enchant_plus:lightning_strike",Enable:false,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium[{id:"enchant_plus:lightning_strike"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.Medium append value {id:"enchant_plus:lightning_strike",Enable:true,Level:1}
    execute unless data storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High[{id:"enchant_plus:lightning_strike"}] run data modify storage asset:custom_ench Data.Loot.Custom[{Namespace:"enchant_plus"}].Enchant.High append value {id:"enchant_plus:lightning_strike",Enable:true,Level:1}
